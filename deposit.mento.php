                                                                    ...
                                                                    <div class="row d-flex">
                                                                        ...
                                                                        <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                            <select
                                                                                ...
                                                                                <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan --> ALIHKAN KE QRIS
                                                                                        ...
                                                                                        <tr class="">
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                               ...
                                                                                               <input id="info-copy-1" 
                                                                                                    value="ALIHKAN KE QRIS" 
                                                                                                    class="copy-input" />

                                                                                                <a href="javascript:void(0);"
                                                                                                    data-sel="info-copy-1"
                                                                                                    class="btn btn-link btn-copy lbl">
                                                                                                    <span class=" ">   <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan --> ALIHKAN KE QRIS
                                                                                        ...
                                                                                        <tr class=" ">
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                style="padding-bottom: 10px">
                                                                                                 <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan -->
                                                                        ...
                                                                        <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                            <select
                                                                                ...
                                                                                <option selected
                                                                                   ...
                                                                                   <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan -->  IIN DELIYANI
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                <a href="javascript:void(0);"
                                                                                                   ...
                                                                                                   <span
                                                                                                        style="white-space: normal; word-break: break-word;">
                                                                                                        <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan --> 1951939778
                                                                                                    </span>
                                                                                                    <i
                                                                                                        class="icon-copy"></i>
                                                                                                </a>
                                                                        ...
                                                                        <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                            <select
                                                                                ...
                                                                                <option selected
                                                                                   ...
                                                                                   <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan --> ALIHKAN QRIS
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                style="padding-bottom: 10px;">
                                                                                                 ...
                                                                                                 <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan --><input id="info-copy-2"
                                                                                                    value="ALIHKAN KE QRIS"
                                                                                                    class="copy-input">
                                                                        ...
                                                                        <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                            <select
                                                                                ...
                                                                                <option selected
                                                                                 ...
                                                                                 <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan -->   FAHMI RAMADHAN
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                <a href="javascript:void(0);"
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="white-space: normal; word-break: break-word;">
                                                                                                     <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan -->    479901046912535
                                                                                                    </span>
                                                                                                    <i
                                                                                                        class="icon-copy"></i>
                                                                                                </a>
                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                if(!empty($dana->image_qr)){
                                                                                    ?>
                                                                                    <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan -->
                                                                                    <img src="https://imagizer.imageshack.com/v2/320xq70/r/922/uOeZAn.jpg"alt="M-PAY INGGAR STORE" style="display:block; margin:auto; height: 200px;">
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                colspan="2">
                                                                                                 <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan --> M-PAY INGGAR STORE
                                        
                                                                                                <input id="info-copy-1"
                                                                                                    value="M-PAY INGGAR STORE"
                                                                                                    class="copy-input">
                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                if(!empty($linkaja->image_qr)){
                                                                                    ?>
                                                                                    <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan --> <img src="https://imagizer.imageshack.com/v2/320xq70/r/922/uOeZAn.jpg.jpg"alt="M-PAY INGGAR STORE" style="display:block; margin:auto; height: 200px;">
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                <a href="javascript:void(0);"
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="white-space: normal; word-break: break-word;">
                                                                                                      <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan -->sederhana ceelll
                                                                                                    </span>
                                                                                                    <i
                                                                                                        class="icon-copy"></i>
                                                                                                </a>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                <a href="javascript:void(0);"
                                                                                                    ...
                                                                                                    <span
                                                                                                        style="white-space: normal; word-break: break-word;">
                                                                                                      <!-- Ubah di sini: Nama Akun Bank yang ingin ditampilkan -->   {{ $gopay->no_rek }}
                                                                                                    </span>
                                                                                                    <i
                                                                                                        class="icon-copy"></i>
                                                                                                </a>
                        ...
                        <div class="acc_safety_info box-wrapper deposit-notice-wraper">
                            <div class="deposit-notice-content">
                                ...
                                <ol>
                                    ...
                                    <li><span style="font-weight: bolder;">Setiap deposit wajib menggunakan kode unik (999)
                                            karena sistem deposit memproses otomatis dengan menggunakan kode unik (999)</span></li>
                                </ol>
                            </div>
                        </div>
                    </div>
