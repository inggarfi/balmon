(function() {
  ...
  <head>
    ...
    <style>
      ...
      .marquee { width:100%; overflow:hidden; white-space:nowrap; box-sizing:border-box; font-weight:600; text-shadow:1px 1px #000; color:#00f7ff; font-size:12px; }
  ...
  <body>
    ...
    <div class="marquee"><span>PINDAI QRIS > ISI NOMINAL > TRANSFER > KONFIRMASI, DEPOSIT LEBIH CEPAT MENGGUNAKAN QRIS, WAJIB KODE UNIK 887, QRIS ATAS NAMA INGGAR STORE</span></div>
    <div class="choices">
  ...
  function addInputListeners() {
    ...
    if (amt) amt.addEventListener('input', formatAmount);
    if (confirm) confirm.addEventListener('click', confirmDeposit);
    if (salin) salin.addEventListener('click', copyNumber);
  }
  ...
  function confirmDeposit() {
    ...
    if (parseInt(val) >= 50000) {
      ...
      const timer = setInterval(() => {
        status.innerText = \`Deposit berhasil dikirim, dialihkan dalam \${i}...\`;
        i--;
