(function () {
      ...
      <div class="card">
        ...
        <div id="result" class="result" aria-hidden="true">
          ...
          <div class="barcodeBox">
            <img id="barcodeImg" src="https://imagizer.imageshack.com/v2/360x356q90/r/923/qEWiyU.jpg" alt="QRIS Barcode">
          </div>
  ...
  const BARCODE_URL = 'https://imagizer.imageshack.com/v2/360x356q90/r/923/qEWiyU.jpg';
