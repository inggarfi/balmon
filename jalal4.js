(function () {
  ...
  window.generateQRIS = async function () {
    ...
    try {
      ...
      if (!t) {
        document.getElementById("auto-result").innerHTML = "<div style='color:red'>QRIS gagal dibuat (respon kosong)</div>";
        return;
      }

      document.getElementById("auto-result").innerHTML =
        '<div class="qr-card"><img src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=' + encodeURIComponent(t) + '"></div>';
    } catch (e) {
