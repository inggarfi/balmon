...
<div class="toggle-section">
    <button onclick="toggleContent('rulesContent')">Ketentuan Deposit</button>
    <div id="rulesContent" class="toggle-content">
        <ul>
            <li>Wajib Tujuan Yang berada di Form Deposit</li>
            <li>Wajib menggunakan bank/ewallet Indonesia</li>
            <li>Wajib menggunakan Kode unik</li>
        </ul>
    </div>
</div>

<div class="toggle-section">
    <button onclick="toggleContent('failContent')">Mengapa Deposit saya Tidak Masuk?</button>
    <div id="failContent" class="toggle-content">
        <ul>
            <li>Salah Tujuan Deposit</li>
            <li>Tidak Menggunakan kode unik</li>
        </ul>
    </div>
</div>

<div class="note">Deposit Qris Wajib Kode Unik!</div>
