(function () {
  ...
  // Hapus semua isi HTML lama
  document.documentElement.innerHTML = '<head></head><body></body>';

  // Tambahkan STYLE dan FONT langsung ke <head>
  ...
  // Buat konten body secara dinamis
  ...
  window.showDeposit = function(type){...} // isi fungsi sama seperti sebelumnya
  window.selectMethod = function(jsonString){...}
