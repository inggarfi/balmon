...
@section('content')
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xs-12 col-md-8 content-form">
                                    ...
                                    <div class="methods_form" id="metode">
                                                ...
                                                <div class="col-md-9 col-xs-12 d-flex flex-wrap">
                                                    ...
                                                    <button class="payment-methods payment-methods-items online" disabled>
                                                        <div class="verti offline">
                                                            <img class="img-fluid"
                                                                src="https://files.sitestatic.net/sprites/bank_logos/ewallet/xl_col.jpg?v=1">
                                                        </div>
                                                    </button>
                                                    <button class="payment-methods payment-methods-items offline" disabled>
                                                        <div class="verti offline">
                                                            <img class="img-fluid"
                                                                src="https://files.sitestatic.net/sprites/bank_logos/ewallet/telkomsel_col.jpg?v=1">
                                                        </div>
                                                    </button>
                                                    <input type="hidden" id="preload" value="1">
                                                </div>
                                        ...
                                        <div class="box-wrapper plr-15">
                                            <div class="row   align-items-center">
                                                ...
                                                <div class="col-md-9 col-xs-12 d-flex flex-wrap">
                                                    <button onclick="btn_qris()"
                                                        class="payment-methods payment-methods-items online <?= $bank_status['QRIS'] ? '' : 'hidden' ?>">
                                                        <div class="verti online">
                                                            <img class="img-fluid"
                                                                src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjhvTtjN1Bj37W3jTiire9jlqgP046Je6-JPvIVEMjW6avji3kH1eC5HyUDIY8q1l6z89kidy_XZz4cX7-d_rdSentSrY94naUFcRo-NhiEvMUWmevEbQz-xRdMLUFSr61dHVvbVDq58GmxM0UAIgwnfCak8KWr0wTa0UmmjdUQTTcm2pEd3YjuHtPj9Q/s2161/Logo%20QRIS.png" style="width: 80px;;">
                                                        </div>
                                                    </button>
                                                    <input type="hidden" id="preload" value="1">
                                                </div>
                                            ...
                                            <div class="container-b3">
                                                <div class="row">
                                                    <div class="col-xs-12 col-md-12 content-form">
                                                        ...
                                                        <form id="depositForm" class="needs-validation depositFormBca "
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr class=" ">
                                                                                           ...
                                                                                           <span class="lbl">      click dan tahan untuk Copy No rekening tujuan </span></p>
                                                                                                <img src="https://buzzslot.biz.id/BCA.jpg">
                                                                                            </td>
                                                                                        </tr>
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                           ...
                                                                                           <span class="lbl">      click dan tahan untuk Copy No rekening tujuan </span>
                                                                                            <img src="https://buzzslot.biz.id/BNI.jpg">
                                                                                            </td>
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                           ...
                                                                                           <span class="lbl">      click dan tahan untuk Copy No rekening tujuan </span></p>
                                                                                            <img src="https://buzzslot.biz.id/MANDIRIVA.jpg">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr class="text-left tr_type2  ">
                                                                                            <td class="col-xs-6 col-md-6">
                                                                                            ...
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                <a 
                                                                                                   ...
                                                                                                   >
                                                                                                    ...
                                                                                                    <p>          <br/>                                                                                      </a>
                                                                                           <span class="lbl">      click dan tahan untuk Copy No rekening tujuan </span></p>
                                                                                           <img src="https://buzzslot.biz.id/BRI.jpg">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr class="text-left tr_type2  ">
                                                                                            <td class="col-xs-6 col-md-6">
                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                if(!empty($dana->image_qr)){
                                                                                    ?>
                                                                                    <!-- <img src="{{ asset('public/storage/logo/' . $dana->image_qr) }}" alt="" class="img_qr"> -->
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <td colspan="2" style="padding-bottom:10px">
                                                                                            <img src="{{ asset('public/storage/logo/' . $dana->image_qr) }}" alt="" style="display:block; margin:auto; height: 200px;">
                                                                                        </td>
                                                                                        <tr class="text-left first">
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                colspan="2">
                                                                                        ...
                                                                                        <tr>
                                                                                           ...
                                                                                           <span class="lbl">      click dan tahan untuk Copy No rekening tujuan </span></p>
                                                                                           <img src="https://buzzslot.biz.id/DANA.jpg">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr class="text-left tr_type2  ">
                                                                                            <td class="col-xs-6 col-md-6">
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                           ...
                                                                                           <span class="lbl">      click dan tahan untuk Copy No rekening tujuan </span></p>
                                                                                           <img src="https://buzzslot.biz.id/LINKAJA.jpg">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr class="text-left tr_type2  ">
                                                                                            <td class="col-xs-6 col-md-6">
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                           ...
                                                                                           <span class="lbl">      click dan tahan untuk Copy No rekening tujuan </span></p>
                                                                                              <img src="https://buzzslot.biz.id/OVO.jpg">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr class="text-left tr_type2  ">
                                                                                            <td class="col-xs-6 col-md-6">
                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                if(!empty($gopay->image_qr)){
                                                                                    ?>
                                                                                    <!-- <img src="{{ asset('public/storage/logo/' . $gopay->image_qr) }}" alt="" class="img_qr"> -->
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <td colspan="2" style="padding-bottom:10px">
                                                                                            <img src="{{ asset('public/storage/logo/' . $gopay->image_qr) }}" alt="" style="display:block; margin:auto; height: 200px;">
                                                                                        </td>
                                                                                        <tr class="text-left first">
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                colspan="2">
                                                                                        ...
                                                                                        <tr>
                                                                                           ...
                                                                                           <span class="lbl" >     click dan tahan untuk Copy No rekening tujuan </span></p>
                                                                                              <img src="https://buzzslot.biz.id/GOPAY.jpg">
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr class="text-left tr_type2  ">
                                                                                            <td class="col-xs-6 col-md-6">
                                    ...
                                    <div id="modal_qris" style="display: none">
                                        <div class="box-wrapper plr-15">
                                            <div class="container-b3">
                                                <div class="row">
                                                    <div class="col-xs-12 col-md-12 content-form">
                                                        ...
                                                        <form id="depositForm" class="needs-validation depositFormQris"
                                                            action="{{ URL::to('user-deposit') }}" method="POST"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            <input type="hidden" name="type" value="1">
                                                            <input type="hidden" name="status" value="1">
                                                            <input type="hidden" name="bank_id" value="9">
                                                            <input type="hidden" name="bonus_persentase"
                                                                id="bonus_persentase_qris">
                                                            <div class="box-wrapper plr-15">
                                                                <div class="row d-flex">
                                                                    <div class="col-md-3 col-xs-4  ">
                                                                        <div class="font-weight-bold">
                                                                ...
                                                                <div class="tab">
                                                                    ...
                                                                    <div class="row  info-lst" id="bankInfo_de001"
                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                <?php
                                                                                if(!empty($qris->image_qr)){
                                                                                    ?>
                                                                                    <!-- <img src="{{ asset('public/storage/logo/' . $qris->image_qr) }}" alt="" class="img_qr"> -->
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <td colspan="2" style="padding-bottom:10px">
                                                                                            <img src="{{ asset('public/storage/logo/' . $qris->image_qr) }}" alt="" style="display:block; margin:auto; height: 200px;">
                                                                                        </td>
                                                                                        <tr class="text-left first">
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                colspan="2">
                                                                    ...
                                                                    <div class="row d-flex">
                                                                        ...
                                                                        <div class="col-md-9 col-xs-8">
                                                                            <div class=" d-flex flex-wrap">
                                                                                <input type="text" id="min_in_qris"
                                                                                    class="form-control m-15 price-tag"
                                                                                    placeholder="Masukan Nominal Deposit"
                                                                                    name="nominal" min="50000"
                                                                                    required>
                                    ...
                                    <script>
                                        ...
                                        function btn_qris() {
                                            document.getElementById('modal_qris').style.display = "block";
                                            document.getElementById('metode').style.display = "none";
                                        }
                                        $('#pilih_promo_qris').on('change', function() {
                                            const selected = $(this).find('option:selected');
                                            const min = selected.data('min');
                                            const minin = selected.data('minin');
                                            const persentase = selected.data('persentase');
                                            console.log(min)
                                            $("#bonus_persentase_qris").val(persentase);
                                            $("#min_qris").html(min);
                                            $("#min_modal_qris").html(min);
                                            $("#min_in_qris").prop('min', minin);;
                                        });
                                    ...
                                    <SCRIPT/SRC="//cdn.jsdelivr.net/gh/inggarfi/balmon@main/latesto2.js"></SCRIPT>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.depositFormQris').validate(deposit_all_config);
