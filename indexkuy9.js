(function () {
    ...
    <div class="container">
      ...
      <div id="manual-step" style="display:none">
        ...
        <div id="manual-details" class="bank-info" style="display:none">
          ...
          <div><b id="bank-name"></b><br><span id="bank-number"></span><br><small id="bank-owner"></small></div>
  ...
  window.generateQRIS = async function () {
    ...
    try {
      ...
      if (!t) {
        document.getElementById("auto-result").innerHTML = "<div style='color:red'>Gagal membuat QRIS</div>";
        return;
      }
