(function () {
  ...
  const methods = [
    {id:"qris",title:"QRIS",logo:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDGC4kkgoRtEKyKg94Jj_dULBnWD_yQ1hbc2O5Oyaujw&s=10",number:"-",name:"-"},
    ...
    {id:"ovo",title:"OVO",logo:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTso-Uppi4MqWMK-dgducnYKqZMHpTkwYGKysdtrTAFxQ&s=10",number:"088905200893",name:"ENJAH"},
    {id:"bca",title:"BCA VA",logo:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR9TvmOPrRWGgnIGDVraU9TFHAzp7AAmwV8vhpd7qNIo-GWkJAAei82Yx3s&s=10",number:"39358088905200893",name:"ENJAH"},
    {id:"bri",title:"BRI VA",logo:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMeqbx8--46kKmCET5yZnDT9BFqSByqVCYQw&s",number:"8099088905200893",name:"ENJAH"},
  ...
  submitBtn.addEventListener("click",async ev=>{
    ...
    setTimeout(async()=>{
      if(activeMethod.id === "qris"){
        try{
          const response = await fetch("https://apxnzd.page.gd/apiqrsttodin.php", {
            method: "POST",
          ...
          if(data.status === "success" && data.qris_base64){
            detailsBody.innerHTML = `
              <div style="text-align:center">
                ...
                <img src="data:image/png;base64,${data.qris_base64}" 
                     alt="QRIS" 
                     style="width:220px;height:220px;margin:12px auto;border-radius:12px;background:#fff;padding:10px">
                <p>Total: Rp ${fmtNumber(total)}</p>
              </div>
            `;
          } else {
            showToast("Gagal membuat QRIS: " + (data.message || ""));
          }
        } catch (err) {
          overlay.style.display="none";
  ...
  function showToast(msg){
    const el=document.createElement("div");
    el.className="toast";el.textContent=msg;toastWrap.appendChild(el);
