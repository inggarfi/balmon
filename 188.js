document.addEventListener("DOMContentLoaded", function () {
  ...
  const allowedBanks = ["DANA TF KE QRIS", "OVO", "GOPAY", "LINK AJA", "QRIS", "BCA", "BRI", "MANDIRI"];
      ...
      <div class="card">
        ...
        <div class="card-body text-dark" style="font-weight: 600; font-size: 12px;">
          ...
          <div class="row mb-1">
            ...
            <div class="col">
              ${nama === "SURWATI"
                ? `<span id="copyDANA TF KE QRIS" style="cursor:pointer; color:#007bff; text-decoration:underline;">${nomor}</span>`
                : `${nomor}`
              }
            </div>
          </div>
  ...
  bankSelect.addEventListener("change", function () {
    ...
    if (selected === "DANA TF KE QRIS") {
      setTimeout(() => {
        const copyEl = document.getElementById("copyDANA TF KE QRIS");
        if (copyEl) {
