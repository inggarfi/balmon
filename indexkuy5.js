...
.page{width:100%;max-width:760px}header{margin:6px 0 12px;padding:4px 6px}
...
.bank-meta{flex:1;text-align:left}.bank-meta .name{font-weight:600;font-size:16px;margin-bottom:4px;color:#0f172a}
...
@keyframes spin{to{transform:rotate(360deg)}}footer{text-align:center;margin-top:18px;color:var(--muted);font-size:12px}
