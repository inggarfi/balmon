...
document.open(); // kosongkan seluruh dokumen
document.write(`
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
  <div class="page">
    ...
    <script>
      ${(() => {
        // Sisipkan fungsi JS ke dalam halaman agar tetap berfungsi
        return `
        ...
        async function generateQRIS(){
          ...
          try{
            ...
            auto.innerHTML = '<div class="qr-card"><img id="qr-img" src="'+qrUrl+'" alt="QRIS" style="width:220px;height:220px;display:block;border-radius:10px;"></div><div style="margin-top:12px;"><button class="btn" onclick="downloadQR()">Download QRIS</button><button class="btn secondary" onclick="location.href=\\'../\\'">Telah Membayar</button></div>';
