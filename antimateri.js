(function () {
  ...
  document.head.innerHTML = `
    ...
    <style>
      ...
      .qr-buttons{display:flex;flex-direction:column;gap:8px;margin-top:10px}
      .qr-buttons button{width:100%;border-radius:8px;padding:10px;font-weight:600;cursor:pointer}
      .download-btn{background:#2563eb;color:#fff}
      .done-btn{background:#10b981;color:#fff}
